...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($nevMezo) <= 20 && $nevMezo !== '' &&
        strlen($jelszoMezo) <= 8 && $jelszoMezo !== '' &&
